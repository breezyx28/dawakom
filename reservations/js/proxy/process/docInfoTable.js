 ...
 export const docInfoTable = (url, columns = [], edit = true , remove = true, deleteUrl, updateUrl) => {
     ...
     if(edit){
        ...
        $(document).on('click', '.edit' ,function(){
         ...
         $('#UpdateSubmit input[name=specialization]').val($(`#${id} .specialization`).text());
         $('#UpdateSubmit input[name=interviewPrice]').val( $(`#${id} .interviewPrice`).text());
