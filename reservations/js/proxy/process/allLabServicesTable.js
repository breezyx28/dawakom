 ...
 export const allLabServicesTable = (url, columns = [], edit = true , remove = true, deleteUrl, updateUrl) => {
    ...
    //         $('#UpdateSubmit input[name=activity]').attr('value',1);
    //     }if(active == "غير نشط"){
    //         $('#UpdateSubmit input[name=activity]').attr('checked', false);
    //         $('#UpdateSubmit input[name=activity]').attr('value',0);
    //     }
