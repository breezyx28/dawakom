import {hospitalDoctorTable} from '../process/hospitalDoctorTable.js';
...
switch (pageName) {
            case 'hospitalDoctors':
                hospitalDoctorTable('hospitalDoctors', column, true, true, 'delete/hospitalDoctors', 'update/hospitalDoctors');
                break;
}
